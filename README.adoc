...
- Installs GPG, Git, Vim, and Bash.
- Sets Vim as default editor.
- Defaults to xterm terminal.
- Sets default Git branch.
- Installs latest Ruby system gems.
...
docker pull bkuhlmann/alpine-ruby:0.1.0   # <= Pull specific version.
----
...
FROM bkuhlmann/alpine-ruby:0.1.0   # <= Specific version.
----
