...
Provides a Ruby focused Docker image with current tooling for development purposes.
...
docker pull bkuhlmann/alpine-ruby:0.5.2   # <= Pull specific version.
----
...
FROM bkuhlmann/alpine-ruby:0.5.2   # <= Specific version.
----
